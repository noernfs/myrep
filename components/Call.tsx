            ...
            <div className="py-5 bg-blue-600 md:py-7 lg:py-14">
                <div className="container mx-auto px-5 xl:max-w-screen-xl">
                    <div className="max-w-lg p-5 mx-auto text-center rounded-lg bg-white">
                        ...
                        <h1 className="mt-2.5 text-3xl font-bold text-gray-900 md:text-4xl">
                            Start your free trial today!
                        </h1>
                        <p className="max-w-lg mt-2.5 mx-auto text-gray-500 md:text-lg">
                            Lorem ipsum dolor sit amet, consectetur adipiscing
                            elit. Suspendisse sodales interdum sapien non
                            pretium.
                        </p>
                        <a
                            href="#"
                            className="block mt-5 px-5 py-3 rounded font-medium text-white bg-blue-600"
                        >
                            Try for free
                        </a>
                    </div>
