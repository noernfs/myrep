...
export const Nav = () => {
    ...
    return (
        <div className=" bg-white sticky top-0 z-50 px-3">
            <div className="px-2 py-0 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl">
                    ...
                    <ul className="flex items-center hidden space-x-8 lg:flex">
                        <li>
                            <Link
                                ...
                                title="Our product"
                                className="font-bold tracking-wide text-gray-500 transition-colors duration-200 hover:text-teal-accent-400"
                            >
                                Profil
                            </Link>
                        </li>
